...
<asp:TextBox runat="server" ID="txtAmount" CssClass="DataInput" onChange="JavaScript:Validate(1)"></asp:TextBox>&nbsp;
...
<asp:TextBox runat="server" ID="txtBank" CssClass="DataInput" onChange="JavaScript:Validate(2)"></asp:TextBox>&nbsp;
...
<asp:TextBox runat="server" ID="txtAccName" CssClass="DataInput" onChange="JavaScript:Validate(3)"></asp:TextBox>&nbsp;
...
<asp:TextBox runat="server" ID="txtAccNumber" CssClass="DataInput" onChange="JavaScript:Validate(4)"></asp:TextBox>&nbsp;
...
<asp:TextBox runat="server" ID="txtBranchName" CssClass="DataInput" onChange="JavaScript:Validate(5)"></asp:TextBox>&nbsp;
...
<asp:TextBox runat="server" ID="txtBranchCode" CssClass="DataInput" onChange="JavaScript:Validate(6)"></asp:TextBox>&nbsp;
